...
@Slf4j
@Data
public class ModelExportCellHandle implements SheetWriteHandler {
    ...
    public void afterSheetCreate(WriteWorkbookHolder writeWorkbookHolder, WriteSheetHolder writeSheetHolder) {
        ...
        // 使用 WriteSheetHolder 获取当前 sheet，workbook.getSheet(sheetName) 在 ExcelWriter 多
        // sheet 场景下可能为 null
        Sheet sheet = writeSheetHolder.getSheet();
        if (sheet == null) {
            log.error("afterSheetCreate: sheet is null, skip header write");
            return;
        }
